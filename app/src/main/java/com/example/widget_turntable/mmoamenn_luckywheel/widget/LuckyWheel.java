package com.example.widget_turntable.mmoamenn_luckywheel.widget;
...
public class LuckyWheel extends FrameLayout implements View.OnTouchListener, WheelView.OnRotationListener {
    ...
    private void initComponent() {
        inflate(getContext(), R.layout.mmonamenn_layout_lucky_wheel, this);
     ...
     */
    public void setLuckyWheelReachTheTarget(WheelView.OnLuckyWheelReachTheTarget onLuckyWheelReachTheTarget) {
