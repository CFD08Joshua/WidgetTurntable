package com.example.widget_turntable.lwang057_luckyturntable;
...
import com.example.widget_turntable.databinding.FragmentLwang057LuckyTurntableBinding;

import java.util.Random;

public class lwang057LuckyTurnTable extends Fragment {
    ...
    FragmentLwang057LuckyTurntableBinding binding;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(getLayoutInflater(), R.layout.fragment_lwang057_lucky_turntable, container, false);
        initView();
